...
class TestImageDimensions:
    ...
    def test_different_image_sizes(self):
        ...
        for size in [256, 512, 1024]:
            ...
            # Verify position values are within bounds
            x_start, y_start, x_end, y_end = dims.get_obstruction_bar_position()
            assert 0 <= x_start < x_end <= size
            assert 0 <= y_start < y_end <= size
...
class TestGeometryType:
    ...
    def test_geometry_type_by_value(self):
        """Test accessing geometry type by value"""
