"""Validator for reflectance parameters (SRP: validates only reflectance values)"""
...
class ReflectanceValidator(BaseValidator):
    """Validates reflectance values (must be between 0.0 and 1.0)"""

    def __init__(self, parameter_name: str):
        """
        Initialize reflectance validator.
    ...
    def validate(self, value: Any, context: Optional[Dict[str, Any]] = None) -> ValidationResult:
        ...
        Args:
            ...
            context: Optional context (unused for reflectance)
