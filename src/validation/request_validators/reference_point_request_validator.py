"""Validator for reference point requests (SRP: validates only reference point requests)"""
...
class ReferencePointRequestValidator(BaseValidator):
    """Validates reference point request structure"""

    def __init__(self):
        """Initialize reference point request validator"""
    ...
    def validate(self, value: Any, context: Optional[Dict[str, Any]] = None) -> ValidationResult:
        """
        Validate reference point request.
